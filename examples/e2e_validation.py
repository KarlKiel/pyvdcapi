...
def validate_complex_device_creation(vdc):
    ...
    brightness_channel = device.add_output_channel(
        channel_type=DSChannelType.BRIGHTNESS, min_value=0.0, max_value=100.0, resolution=0.1, initial_value=50.0
    )
    ...
    sensor = device.add_sensor(sensor_type="temperature", unit="°C", min_value=-40.0, max_value=80.0)
