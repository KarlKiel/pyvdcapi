...
class VdSDProperties:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        Args:
            ...
            model_features: Device model features for visibility matrix.
                This is required by the specification and defaults to an
                empty dict if not explicitly provided.
    ...
    def add_model_feature(self, feature: str, enabled: bool = True) -> None:
        ...
        if feature not in VALID_MODEL_FEATURES:
            raise ValueError(f"Invalid model feature '{feature}'. Must be one of: {sorted(VALID_MODEL_FEATURES)}")
