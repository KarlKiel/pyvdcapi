...
class YAMLPersistence:
    ...
    def __init__(self, file_path: str, auto_save: bool = True, enable_backup: bool = True):
        ...
        self._lock = Lock()
        self._data: Dict[str, Any] = {"vdc_host": {}, "vdcs": {}, "vdsds": {}}
    ...
    def _save_internal(self) -> None:
        ...
        try:
            ...
            temp_fd, temp_path = tempfile.mkstemp(dir=dir_path, prefix=".tmp_", suffix=".yaml", text=True)

            try:
                with os.fdopen(temp_fd, "w", encoding="utf-8") as f:
                    yaml.safe_dump(self._data, f, default_flow_style=False, allow_unicode=True, sort_keys=False)
                ...
                try:
                    ...
                    logger.debug(f"Failed to remove temp file {temp_path}: {cleanup_exc}")
                raise
    ...
    def clear_all(self) -> None:
        ...
        with self._lock:
            self._data = {"vdc_host": {}, "vdcs": {}, "vdsds": {}}
