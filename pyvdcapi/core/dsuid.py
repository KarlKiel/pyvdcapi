...
class DSUIDGenerator:
    ...
    def generate(self, namespace: DSUIDNamespace, enumeration: int = 0) -> str:
        ...
        """
        return self._generate_dsuid(namespace.value, self.mac_address, self.vendor_id, enumeration)
    ...
    def generate_vdc_host_dsuid(mac_address: str, vendor_id: str = "KarlKiel") -> str:
        ...
        Returns:
            34 character hex string (17 bytes)
        """
        return DSUIDGenerator._generate_dsuid(DSUIDGenerator.NAMESPACE_VDC_HOST, mac_address, vendor_id, 0)
    ...
    def generate_vdc_dsuid(mac_address: str, vdc_index: int, vendor_id: str = "KarlKiel") -> str:
        ...
        return DSUIDGenerator._generate_dsuid(DSUIDGenerator.NAMESPACE_VDC, identifier, vendor_id, vdc_index)

    @staticmethod
    def generate_vdsd_dsuid(hardware_guid: str, vendor_id: str = "KarlKiel", subdevice_index: int = 0) -> str:
        """
        ...
        Returns:
            34 character hex string (17 bytes)
        """
        return DSUIDGenerator._generate_dsuid(DSUIDGenerator.NAMESPACE_VDSD, hardware_guid, vendor_id, subdevice_index)

    @staticmethod
    def _generate_dsuid(namespace: str, identifier: str, vendor_id: str, subdevice_index: int) -> str:
        """
