...
class Vdc:
    ...
    def __init__(
        ...
        **properties,
        ...
        self.dsuid = dsuid_gen.generate(DSUIDNamespace.VDC, enumeration=enumeration)
    ...
    def remove_vdsd(self, dsuid: str) -> bool:
        ...
        # Device reference will be removed; no need to keep local var
    ...
    def set_properties(self, properties: Any) -> None:
        ...
        # Persist changes
        vdc_config = {**self._common_props.to_dict(), **self._vdc_props.to_dict()}
        self._persistence.set_vdc(self.dsuid, vdc_config)

        logger.debug("vDC properties updated and persisted")
