...
async def main():
    ...
    print(f"  Port: 8440")
    print(f"  Service announcement: ENABLED")
    ...
    sensor = vdc.create_vdsd(
        ...
        primary_group=DSGroup.BLACK  # Joker
    )
    sensor.add_sensor(
        sensor_id=0,
    ...
    # 4. Button input
    button = vdc.create_vdsd(
        name="Wall Switch",
        model="Button Input",
        primary_group=DSGroup.BLACK
    )
    button.add_button(
        button_id=0,
    ...
    print(f"✓ Listening on port 8440")
